...
void load_instance() {
    ...
    agent_names[5] = 'F';
    agent_names[6] = 'G';
    inst.starts[0] = (Point){1, 1}; inst.goals[0] = (Point){1, 6};
    inst.starts[1] = (Point){1, 3}; inst.goals[1] = (Point){6, 6};
    inst.starts[2] = (Point){1, 5}; inst.goals[2] = (Point){1, 0};
    ...
    inst.starts[6] = (Point){5, 1}; inst.goals[6] = (Point){5, 6};
