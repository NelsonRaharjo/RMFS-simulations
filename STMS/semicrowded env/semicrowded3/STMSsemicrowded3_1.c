...
void load_instance() {
    ...
    inst.starts[0] = (Point){1, 1}; inst.goals[0] = (Point){8, 8};
    inst.starts[1] = (Point){7, 3}; inst.goals[1] = (Point){0, 8};
    inst.starts[2] = (Point){3, 3}; inst.goals[2] = (Point){5, 8};
    inst.starts[3] = (Point){5, 3}; inst.goals[3] = (Point){3, 8};
    inst.starts[4] = (Point){1, 5}; inst.goals[4] = (Point){8, 1};
    inst.starts[5] = (Point){3, 5}; inst.goals[5] = (Point){5, 0};
    inst.starts[6] = (Point){5, 5}; inst.goals[6] = (Point){3, 0};
    inst.starts[7] = (Point){1, 7}; inst.goals[7] = (Point){8, 0};
    inst.starts[8] = (Point){7, 7}; inst.goals[8] = (Point){0, 0};
