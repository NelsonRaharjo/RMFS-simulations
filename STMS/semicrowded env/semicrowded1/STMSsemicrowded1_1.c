...
void load_instance() {
    ...
    inst.starts[2] = (Point){1, 3}; inst.goals[2] = (Point){3, 0};
    inst.starts[3] = (Point){3, 3}; inst.goals[3] = (Point){0, 3};
    inst.starts[4] = (Point){5, 3}; inst.goals[4] = (Point){3, 6};
    inst.starts[5] = (Point){1, 5}; inst.goals[5] = (Point){6, 0};
    inst.starts[6] = (Point){5, 5}; inst.goals[6] = (Point){0, 0};
