...
void load_instance() {
    ...
    inst.starts[0] = (Point){1, 1}; inst.goals[0] = (Point){8, 5};
    inst.starts[1] = (Point){7, 1}; inst.goals[1] = (Point){0, 4};
    inst.starts[2] = (Point){1, 7}; inst.goals[2] = (Point){8, 4};
    inst.starts[3] = (Point){7, 7}; inst.goals[3] = (Point){8, 3};
    inst.starts[4] = (Point){7, 3}; inst.goals[4] = (Point){8, 7};
