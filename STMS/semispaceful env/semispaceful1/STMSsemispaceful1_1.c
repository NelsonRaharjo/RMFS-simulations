...
void load_instance() {
    ...
    inst.starts[1] = (Point){7, 1}; inst.goals[1] = (Point){0, 8};
    inst.starts[2] = (Point){1, 7}; inst.goals[2] = (Point){8, 0};
    inst.starts[3] = (Point){7, 7}; inst.goals[3] = (Point){0, 0};
    inst.starts[4] = (Point){1, 3}; inst.goals[4] = (Point){8, 5};
