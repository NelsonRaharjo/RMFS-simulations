...
void load_instance() {
    ...
    agent_names[5] = 'F';
    agent_names[6] = 'G';
    inst.starts[0] = (Point){1, 1}; inst.goals[0] = (Point){10, 5};
    inst.starts[1] = (Point){3, 3}; inst.goals[1] = (Point){10, 8};
    inst.starts[2] = (Point){5, 1}; inst.goals[2] = (Point){0, 5};
    inst.starts[3] = (Point){7, 3}; inst.goals[3] = (Point){10, 6};
    inst.starts[4] = (Point){1, 5}; inst.goals[4] = (Point){10, 3};
    inst.starts[5] = (Point){5, 7}; inst.goals[5] = (Point){5, 0};
    inst.starts[6] = (Point){9, 9}; inst.goals[6] = (Point){0, 3};
