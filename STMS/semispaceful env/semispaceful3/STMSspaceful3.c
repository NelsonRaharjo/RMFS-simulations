...
void load_instance() {
    ...
    inst.starts[0] = (Point){1, 1}; inst.goals[0] = (Point){10, 10};
    inst.starts[1] = (Point){5, 1}; inst.goals[1] = (Point){5, 10};
    inst.starts[2] = (Point){3, 3}; inst.goals[2] = (Point){0, 10};
    inst.starts[3] = (Point){5, 5}; inst.goals[3] = (Point){9, 0};
    inst.starts[4] = (Point){7, 7}; inst.goals[4] = (Point){10, 0};
    inst.starts[5] = (Point){3, 0}; inst.goals[5] = (Point){5, 0};
    inst.starts[6] = (Point){9, 9}; inst.goals[6] = (Point){0, 0};
