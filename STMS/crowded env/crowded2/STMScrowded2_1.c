...
void load_instance() {
    ...
    agent_names[7] = 'H';
    agent_names[8] = 'I';
    inst.starts[0] = (Point){1, 1}; inst.goals[0] = (Point){6, 1};
    inst.starts[1] = (Point){1, 3}; inst.goals[1] = (Point){6, 3};
    inst.starts[2] = (Point){1, 5}; inst.goals[2] = (Point){6, 5};
    inst.starts[3] = (Point){3, 1}; inst.goals[3] = (Point){3, 6};
    inst.starts[4] = (Point){3, 3}; inst.goals[4] = (Point){0, 6};
    inst.starts[5] = (Point){3, 5}; inst.goals[5] = (Point){3, 0};
    inst.starts[6] = (Point){5, 1}; inst.goals[6] = (Point){0, 0};
    inst.starts[7] = (Point){5, 3}; inst.goals[7] = (Point){0, 3};
    inst.starts[8] = (Point){5, 5}; inst.goals[8] = (Point){0, 5};
    inst.makespan = 0; 
}
