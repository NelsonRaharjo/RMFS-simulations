...
void load_instance() {
    ...
    inst.starts[1] = (Point){3, 1}; inst.goals[1] = (Point){3, 6};
    inst.starts[2] = (Point){5, 1}; inst.goals[2] = (Point){0, 6};
    inst.starts[3] = (Point){1, 3}; inst.goals[3] = (Point){6, 3};
    inst.starts[4] = (Point){3, 3}; inst.goals[4] = (Point){5, 0};
    inst.starts[5] = (Point){5, 3}; inst.goals[5] = (Point){0, 3};
    inst.starts[6] = (Point){1, 5}; inst.goals[6] = (Point){6, 0};
    inst.starts[7] = (Point){3, 5}; inst.goals[7] = (Point){3, 0};
    inst.starts[8] = (Point){5, 5}; inst.goals[8] = (Point){0, 0};
