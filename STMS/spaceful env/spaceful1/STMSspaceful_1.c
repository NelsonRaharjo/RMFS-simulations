...
void load_instance() {
    ...
    inst.starts[1] = (Point){9, 1}; inst.goals[1] = (Point){0, 10};
    inst.starts[2] = (Point){1, 9}; inst.goals[2] = (Point){10, 0};
    inst.starts[3] = (Point){9, 9}; inst.goals[3] = (Point){0, 0};
    inst.starts[4] = (Point){5, 5}; inst.goals[4] = (Point){0, 5};
