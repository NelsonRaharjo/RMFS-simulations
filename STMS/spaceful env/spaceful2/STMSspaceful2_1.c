...
void load_instance() {
    ...
    inst.starts[0] = (Point){1, 1}; inst.goals[0] = (Point){10, 9};
    inst.starts[1] = (Point){1, 3}; inst.goals[1] = (Point){10, 7};
    inst.starts[2] = (Point){1, 5}; inst.goals[2] = (Point){10, 5};
    inst.starts[3] = (Point){1, 7}; inst.goals[3] = (Point){10, 3};
    inst.starts[4] = (Point){1, 9}; inst.goals[4] = (Point){10, 1};
