...
void setup_agents() {
    agents[0] = (Agent){'A', {1, 1}, {10, 10}, {1, 1}, false};
    agents[1] = (Agent){'B', {1, 5}, {10, 5}, {1, 5}, false};
    agents[2] = (Agent){'C', {3, 3}, {10, 0}, {3, 3}, false};
    agents[3] = (Agent){'D', {5, 5}, {0, 9}, {5, 5}, false};
    agents[4] = (Agent){'E', {7, 7}, {0, 10}, {7, 7}, false};
    agents[5] = (Agent){'F', {9, 5}, {0, 5}, {9, 5}, false};
    agents[6] = (Agent){'G', {9, 9}, {0, 0}, {9, 9}, false};
