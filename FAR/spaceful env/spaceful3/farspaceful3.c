...
void setup_agents() {
    agents[0] = (Agent){'A', {1, 5}, {10, 5}, {1, 5}, false};
    agents[1] = (Agent){'B', {3, 3}, {7, 10}, {3, 3}, false};
    agents[2] = (Agent){'C', {5,7}, {0, 5}, {5, 7}, false};
    agents[3] = (Agent){'D', {7,1}, {0, 10}, {7, 1}, false};
    agents[4] = (Agent){'E', {9, 9}, {3, 10}, {9, 9}, false};
