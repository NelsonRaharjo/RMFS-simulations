...
void setup_agents() {
    agents[0] = (Agent){'A', {1, 1}, {9, 10}, {1, 1}, false};
    agents[1] = (Agent){'B', {3, 1}, {7, 10}, {3, 1}, false};
    agents[2] = (Agent){'C', {5,1}, {5, 10}, {5, 1}, false};
    agents[3] = (Agent){'D', {7,1}, {3, 10}, {7, 1}, false};
    agents[4] = (Agent){'E', {9, 1}, {1, 10}, {9, 1}, false};
    agent_count = 5;
