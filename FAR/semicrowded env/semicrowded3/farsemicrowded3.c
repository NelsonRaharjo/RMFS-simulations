...
void setup_agents() {
    agents[0] = (Agent){'A', {1, 1}, {8, 8}, {1, 1}, false};
    agents[1] = (Agent){'B', {1, 7}, {8, 0}, {1, 7}, false};
    agents[2] = (Agent){'C', {3, 3}, {8, 5}, {3, 3}, false};
    agents[3] = (Agent){'D', {3, 5}, {8, 3}, {3, 5}, false};
    agents[4] = (Agent){'E', {5, 1}, {1, 8}, {5, 1}, false};
    agents[5] = (Agent){'F', {5, 3}, {0, 5}, {5, 3}, false};
    agents[6] = (Agent){'G', {5, 5}, {0, 3}, {5, 5}, false};
    agents[7] = (Agent){'H', {7, 1}, {0, 8}, {7, 1}, false};
    agents[8] = (Agent){'I', {7, 7}, {0, 0}, {7, 7}, false};
