...
void setup_agents() {
    agents[0] = (Agent){'A', {1, 1}, {0, 8}, {1, 1}, false};
    agents[1] = (Agent){'B', {3, 3}, {7, 0}, {3, 3}, false};
    agents[2] = (Agent){'C', {5, 5}, {0, 7}, {5, 5}, false};
    agents[3] = (Agent){'D', {7, 7}, {3, 8}, {7, 7}, false};
    agents[4] = (Agent){'E', {7, 1}, {0, 3}, {7, 1}, false};
    agents[5] = (Agent){'F', {5, 3}, {8, 8}, {5, 3}, false};
    agents[6] = (Agent){'G', {3, 5}, {5, 0}, {3, 5}, false};
    agents[7] = (Agent){'H', {1, 7}, {3, 0}, {1, 7}, false};
    agents[8] = (Agent){'I', {1, 3}, {5, 8}, {1, 3}, false};
