...
void setup_agents() {
    agents[0] = (Agent){'A', {1, 1}, {3, 6}, {1, 1}, false};
    agents[1] = (Agent){'B', {3, 1}, {1, 6}, {3, 1}, false};
    agents[2] = (Agent){'C', {5, 1}, {6, 3}, {5, 1}, false};
    agents[3] = (Agent){'D', {1, 3}, {5, 6}, {1, 3}, false};
    agents[4] = (Agent){'E', {3, 3}, {0, 6}, {3, 3}, false};
    agents[5] = (Agent){'F', {5, 3}, {0, 3}, {5, 3}, false};
    agents[6] = (Agent){'G', {1, 5}, {4, 0}, {1, 5}, false};
    agents[7] = (Agent){'H', {3, 5}, {0, 0}, {3, 5}, false};
    agents[8] = (Agent){'I', {5, 5}, {2, 0}, {5, 5}, false};
