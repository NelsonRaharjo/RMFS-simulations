...
void setup_agents() {
    ...
    agents[1] = (Agent){'B', {1, 3}, {6, 3}, {1, 3}, false};
    agents[2] = (Agent){'C', {1, 5}, {6, 0}, {1, 5}, false};
    agents[3] = (Agent){'D', {3, 1}, {3, 6}, {3, 1}, false};
    agents[4] = (Agent){'E', {3, 3}, {0, 5}, {3, 3}, false};
    agents[5] = (Agent){'F', {3, 5}, {3, 0}, {3, 5}, false};
    agents[6] = (Agent){'G', {5, 1}, {0, 6}, {5, 1}, false};
    agents[7] = (Agent){'H', {5, 3}, {0, 3}, {5, 3}, false};
    agents[8] = (Agent){'I', {5, 5}, {0, 0}, {5, 5}, false};
