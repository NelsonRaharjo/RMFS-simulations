...
void setup_agents() {
    agents[0] = (Agent){'A', {1, 1}, {10, 9}, {1, 1}, false};
    agents[1] = (Agent){'B', {1, 5}, {10, 5}, {1, 5}, false};
    agents[2] = (Agent){'C', {1, 9}, {10, 1}, {1, 9}, false};
    agents[3] = (Agent){'D', {5, 1}, {0, 2}, {5, 1}, false};
    agents[4] = (Agent){'E', {5, 5}, {10, 6}, {5, 5}, false};
    agents[5] = (Agent){'F', {5, 9}, {10, 0}, {5, 9}, false};
    agents[6] = (Agent){'G', {9, 1}, {0, 9}, {9, 1}, false};
    agents[7] = (Agent){'H', {9, 5}, {0, 5}, {9, 5}, false};
    agents[8] = (Agent){'I', {9, 9}, {0, 1}, {9, 9}, false};
