...
void setup_agents() {
    agents[0] = (Agent){'A', {1, 1}, {8, 1}, {1, 1}, false};
    agents[1] = (Agent){'B', {3, 1}, {8, 2}, {3, 1}, false};
    agents[2] = (Agent){'C', {3, 3}, {8, 5}, {3, 3}, false};
    agents[3] = (Agent){'D', {3, 5}, {8, 6}, {3, 5}, false};
    agents[4] = (Agent){'E', {5, 5}, {0, 1}, {5, 5}, false};
    agents[5] = (Agent){'F', {5, 7}, {0, 4}, {5, 7}, false};
    agents[6] = (Agent){'G', {7, 7}, {0, 7}, {7, 7}, false};
