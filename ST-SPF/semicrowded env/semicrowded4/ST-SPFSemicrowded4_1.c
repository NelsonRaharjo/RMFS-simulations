...
int main() {
    ...
    agent_count = 9;
    agents[0] = (Agent){ .id='A', .start={1,1}, .goal={8,0}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={3,3}, .goal={0,7}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={5,5}, .goal={7,0}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={7,7}, .goal={8,3}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={1,7}, .goal={3,0}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='F', .start={3,5}, .goal={8,8}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='G', .start={5,3}, .goal={0,5}, .path={{0}}, .path_len=0, .active=true };
    agents[7] = (Agent){ .id='H', .start={7,1}, .goal={0,3}, .path={{0}}, .path_len=0, .active=true };
    agents[8] = (Agent){ .id='I', .start={3,1}, .goal={8,5}, .path={{0}}, .path_len=0, .active=true };
