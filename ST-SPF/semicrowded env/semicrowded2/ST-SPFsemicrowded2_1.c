...
int main() {
    ...
    agent_count = 7;
    agents[0] = (Agent){ .id='A', .start={1,1}, .goal={1,6}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={1,3}, .goal={6,6}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={1,5}, .goal={1,0}, .path={{0}}, .path_len=0, .active=true };
    ...
    agents[6] = (Agent){ .id='G', .start={5,1}, .goal={5,6}, .path={{0}}, .path_len=0, .active=true };
