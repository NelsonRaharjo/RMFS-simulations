...
int main() {
    ...
    agents[2] = (Agent){ .id='C', .start={1,3}, .goal={3,0}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={3,3}, .goal={0,3}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={5,3}, .goal={3,6}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='F', .start={1,5}, .goal={6,0}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='G', .start={5,5}, .goal={0,0}, .path={{0}}, .path_len=0, .active=true };
