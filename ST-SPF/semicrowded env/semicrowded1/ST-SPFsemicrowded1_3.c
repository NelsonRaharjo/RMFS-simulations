...
int main() {
    ...
    agents[1] = (Agent){ .id='B', .start={0,2}, .goal={0,6}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={2,0}, .goal={3,0}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='F', .start={5,4}, .goal={6,0}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='G', .start={3,2}, .goal={0,0}, .path={{0}}, .path_len=0, .active=true };
