...
int main() {
    ...
    agent_count = 7;
    agents[0] = (Agent){ .id='A', .start={2,8}, .goal={8,8}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={0,2}, .goal={0,8}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='E', .start={8,4}, .goal={8,1}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='F', .start={6,3}, .goal={5,0}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='G', .start={4,0}, .goal={3,0}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='H', .start={6,6}, .goal={8,0}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='I', .start={4,2}, .goal={0,0}, .path={{0}}, .path_len=0, .active=true };
