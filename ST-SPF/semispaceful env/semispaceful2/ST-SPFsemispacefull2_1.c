...
int main() {
    ...
    agent_count = 5;
    agents[0] = (Agent){ .id='A', .start={1,1}, .goal={8,5}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={7,1}, .goal={0,4}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={1,7}, .goal={8,4}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={7,7}, .goal={8,3}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={7,3}, .goal={8,7}, .path={{0}}, .path_len=0, .active=true };
