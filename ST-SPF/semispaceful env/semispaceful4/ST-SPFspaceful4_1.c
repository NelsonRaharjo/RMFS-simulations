...
int main() {
    ...
    agent_count = 7;
    agents[0] = (Agent){ .id='A', .start={1,1}, .goal={10,5}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={3,3}, .goal={10,8}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={5,1}, .goal={0,5}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={7,3}, .goal={10,6}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={1,5}, .goal={10,3}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='F', .start={5,7}, .goal={5,0}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='G', .start={9,9}, .goal={0,3}, .path={{0}}, .path_len=0, .active=true };
