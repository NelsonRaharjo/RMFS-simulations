...
int main() {
    ...
    agents[2] = (Agent){ .id='C', .start={1,7}, .goal={8,0}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={7,7}, .goal={0,0}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={1,3}, .goal={8,5}, .path={{0}}, .path_len=0, .active=true };
