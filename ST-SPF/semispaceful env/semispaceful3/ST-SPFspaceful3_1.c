...
int main() {
    ...
    agent_count = 7;
    agents[0] = (Agent){ .id='A', .start={1,1}, .goal={10,10}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={5,1}, .goal={5,10}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={3,3}, .goal={0,10}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={5,5}, .goal={9,0}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={7,7}, .goal={10,0}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='F', .start={5,9}, .goal={5,0}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='G', .start={9,9}, .goal={0,0}, .path={{0}}, .path_len=0, .active=true };
