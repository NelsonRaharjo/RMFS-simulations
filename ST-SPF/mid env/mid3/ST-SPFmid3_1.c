...
int main() {
    ...
    agent_count = 9;
    agents[0] = (Agent){ .id='A', .start={1,1}, .goal={9,10}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={5,1}, .goal={5,10}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={9,1}, .goal={1,10}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={1,5}, .goal={2,0}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={5,5}, .goal={6,10}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='F', .start={9,5}, .goal={0,10}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='G', .start={1,9}, .goal={9,0}, .path={{0}}, .path_len=0, .active=true };
    agents[7] = (Agent){ .id='H', .start={5,9}, .goal={5,0}, .path={{0}}, .path_len=0, .active=true };
    agents[8] = (Agent){ .id='I', .start={9,9}, .goal={1,0}, .path={{0}}, .path_len=0, .active=true }; 
