...
int main() {
    ...
    agent_count = 6;
    agents[0] = (Agent){ .id='A', .start={4,10}, .goal={9,10}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='C', .start={2,6}, .goal={1,10}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='F', .start={0,7}, .goal={0,10}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='G', .start={8,4}, .goal={9,0}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='H', .start={6,1}, .goal={5,0}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='I', .start={0,6}, .goal={1,0}, .path={{0}}, .path_len=0, .active=true };
