...
int main() {
    ...
    agent_count = 7;
    agents[0] = (Agent){ .id='A', .start={1,1}, .goal={1,8}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={1,3}, .goal={2,8}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={3,3}, .goal={5,8}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={5,3}, .goal={6,8}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={5,5}, .goal={1,0}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='F', .start={7,5}, .goal={4,0}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='G', .start={7,7}, .goal={7,0}, .path={{0}}, .path_len=0, .active=true };
