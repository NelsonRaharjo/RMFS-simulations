...
int main() {
    ...
    agent_count = 9;
    agents[0] = (Agent){ .id='A', .start={1,1}, .goal={6,1}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={1,3}, .goal={6,3}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={1,5}, .goal={6,5}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={3,1}, .goal={3,6}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={3,3}, .goal={0,6}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='F', .start={3,5}, .goal={3,0}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='G', .start={5,1}, .goal={0,0}, .path={{0}}, .path_len=0, .active=true };
    agents[7] = (Agent){ .id='H', .start={5,3}, .goal={0,3}, .path={{0}}, .path_len=0, .active=true };
    agents[8] = (Agent){ .id='I', .start={5,5}, .goal={0,1}, .path={{0}}, .path_len=0, .active=true };
