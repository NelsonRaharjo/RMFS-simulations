...
int main() {
    ...
    agent_count = 7;
    agents[0] = (Agent){ .id='A', .start={2,6}, .goal={6,6}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={2,5}, .goal={3,6}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={0,2}, .goal={0,6}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={6,4}, .goal={6,3}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='G', .start={4,4}, .goal={6,0}, .path={{0}}, .path_len=0, .active=true };
    agents[5] = (Agent){ .id='H', .start={4,0}, .goal={3,0}, .path={{0}}, .path_len=0, .active=true };
    agents[6] = (Agent){ .id='I', .start={3,2}, .goal={0,0}, .path={{0}}, .path_len=0, .active=true };
