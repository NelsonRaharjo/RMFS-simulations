...
int main() {
    ...
    agent_count = 4;
    agents[0] = (Agent){ .id='A', .start={4,10}, .goal={10,10}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={0,4}, .goal={0,10}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={10,6}, .goal={10,0}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={2,4}, .goal={0,0}, .path={{0}}, .path_len=0, .active=true };
