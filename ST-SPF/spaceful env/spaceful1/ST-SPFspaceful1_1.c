...
int main() {
    ...
    agents[1] = (Agent){ .id='B', .start={9,1}, .goal={0,10}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={1,9}, .goal={10,0}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={9,9}, .goal={0,0}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={5,5}, .goal={0,5}, .path={{0}}, .path_len=0, .active=true };
