...
int main() {
    ...
    agent_count = 5;
    agents[0] = (Agent){ .id='A', .start={5,1}, .goal={5,10}, .path={{0}}, .path_len=0, .active=true };
    agents[1] = (Agent){ .id='B', .start={3,3}, .goal={10,7}, .path={{0}}, .path_len=0, .active=true };
    agents[2] = (Agent){ .id='C', .start={7,5}, .goal={5,0}, .path={{0}}, .path_len=0, .active=true };
    agents[3] = (Agent){ .id='D', .start={1,7}, .goal={10,0}, .path={{0}}, .path_len=0, .active=true };
    agents[4] = (Agent){ .id='E', .start={9,9}, .goal={10,3}, .path={{0}}, .path_len=0, .active=true };
