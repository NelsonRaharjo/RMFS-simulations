...
int main() {
    ...
    num_agents = 7;
    agents[0].start = (Position){1, 1};agents[0].goal = (Position){6, 6};
    agents[1].start = (Position){5, 1};agents[1].goal = (Position){0, 6};
    agents[2].start = (Position){1, 3};agents[2].goal = (Position){3, 0};
    agents[3].start = (Position){3, 3};agents[3].goal = (Position){0, 3};
    agents[4].start = (Position){5, 3};agents[4].goal = (Position){3, 6};
    agents[5].start = (Position){1, 5};agents[5].goal = (Position){6, 0};
    agents[6].start = (Position){5, 5};agents[6].goal = (Position){0, 0};
