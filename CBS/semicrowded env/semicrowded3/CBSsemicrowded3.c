...
int main() {
    ...
    num_agents = 9;
    agents[0].start = (Position){1, 1}; agents[0].goal = (Position){8, 8};
    agents[1].start = (Position){7, 1}; agents[1].goal = (Position){0, 8};
    agents[2].start = (Position){3, 3}; agents[2].goal = (Position){5, 8};
    agents[3].start = (Position){5, 3}; agents[3].goal = (Position){3, 8};
    agents[4].start = (Position){1, 5}; agents[4].goal = (Position){8, 1};
    agents[5].start = (Position){3, 5}; agents[5].goal = (Position){5, 0};
    agents[6].start = (Position){5, 5}; agents[6].goal = (Position){3, 0};
    agents[7].start = (Position){1, 7}; agents[7].goal = (Position){8, 0};
    agents[8].start = (Position){7, 7}; agents[8].goal = (Position){0, 0};
