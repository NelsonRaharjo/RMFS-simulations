...
void cbs() {
    ...
    for (int step = 1; step < MAX_STEPS; step++) {
        ...
        // If a conflict was found and resolved, recheck this step for new conflicts
        if (conflict_found) step--;
    }
...
int main() {
    ...
    num_agents = 9;
    agents[0].start = (Position){1, 1};agents[0].goal = (Position){6, 1};
    agents[1].start = (Position){1, 3};agents[1].goal = (Position){6, 3};
    agents[2].start = (Position){1, 5};agents[2].goal = (Position){6, 5};
    agents[3].start = (Position){3, 1};agents[3].goal = (Position){3, 6};
    agents[4].start = (Position){3, 3};agents[4].goal = (Position){0, 6};
    agents[5].start = (Position){3, 5};agents[5].goal = (Position){3, 0};
    agents[6].start = (Position){5, 1};agents[6].goal = (Position){0, 0};
    agents[7].start = (Position){5, 3};agents[7].goal = (Position){0, 3};
    agents[8].start = (Position){5, 5};agents[8].goal = (Position){0, 5};
