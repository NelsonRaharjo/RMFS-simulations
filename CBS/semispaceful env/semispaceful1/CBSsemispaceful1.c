...
int main() {
    ...
    agents[2].start = (Position){1, 7};agents[2].goal = (Position){8, 0};
    agents[3].start = (Position){7, 7};agents[3].goal = (Position){0, 0};
    agents[4].start = (Position){1, 3};agents[4].goal = (Position){8, 5};  
