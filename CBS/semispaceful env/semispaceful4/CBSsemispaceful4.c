...
int main() {
    ...
    num_agents = 7;
    agents[0].start = (Position){1, 1}; agents[0].goal = (Position){10, 5};
    agents[1].start = (Position){3, 3}; agents[1].goal = (Position){10, 8};
    agents[2].start = (Position){5, 1}; agents[2].goal = (Position){0, 5};
    agents[3].start = (Position){7, 3}; agents[3].goal = (Position){10, 6};
    agents[4].start = (Position){1, 5}; agents[4].goal = (Position){10, 3};
    agents[5].start = (Position){5, 7}; agents[5].goal = (Position){5, 0};
    agents[6].start = (Position){9, 9}; agents[6].goal = (Position){0, 3};
