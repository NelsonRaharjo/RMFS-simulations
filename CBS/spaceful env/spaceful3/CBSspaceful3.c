...
int main() {
    ...
    num_agents = 5;
    agents[0].start = (Position){5, 1}; agents[0].goal = (Position){5, 10};
    agents[1].start = (Position){3, 3}; agents[1].goal = (Position){10, 7};
    agents[2].start = (Position){7, 5}; agents[2].goal = (Position){5, 0};
    agents[3].start = (Position){1, 7}; agents[3].goal = (Position){10, 0};
    agents[4].start = (Position){9, 9}; agents[4].goal = (Position){10, 3};
