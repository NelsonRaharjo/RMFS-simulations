...
int main() {
    ...
    agents[1].start = (Position){9, 1}; agents[1].goal = (Position){0, 10};
    agents[2].start = (Position){1, 9}; agents[2].goal = (Position){10, 0};
    agents[3].start = (Position){9, 9}; agents[3].goal = (Position){0, 0};
    agents[4].start = (Position){5, 5}; agents[4].goal = (Position){0, 5};
