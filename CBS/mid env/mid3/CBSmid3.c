...
int main() {
    ...
    num_agents = 9;
    agents[0].start = (Position){1, 1}; agents[0].goal = (Position){9, 10};
    agents[1].start = (Position){5, 1}; agents[1].goal = (Position){5, 10};
    agents[2].start = (Position){9, 1}; agents[2].goal = (Position){1, 10};
    agents[3].start = (Position){1, 5}; agents[3].goal = (Position){2, 0};
    agents[4].start = (Position){5, 5}; agents[4].goal = (Position){6, 10};
    agents[5].start = (Position){9, 5}; agents[5].goal = (Position){0, 10};
    agents[6].start = (Position){1, 9}; agents[6].goal = (Position){9, 0};
    agents[7].start = (Position){5, 9}; agents[7].goal = (Position){5, 0};
    agents[8].start = (Position){9, 9}; agents[8].goal = (Position){1, 0};
